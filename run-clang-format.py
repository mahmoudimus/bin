...
def main():
    ...
    parser.add_argument(
        "--ignore-file",
        metavar="path to file (including file name)",
        default=DEFAULT_CLANG_FORMAT_IGNORE,
        help="path to clang-format-ignore which will be used. By default .clang-format-ignore",
    )
    ...
    excludes = excludes_from_file(args.ignore_file)
