...
# Borrowed from here: https://github.com/mal/docker-for-mac-host-bridge
# Modified by mahmoud so I can use the TunnelBlick tun/tap modules instead of TunTap
...
install_tuntap_driver() {
  ...
  log Loading tuntap kernel extension from tunneblick
  sudo kextunload -b net.tunnelblick.tap
  # https://developer.apple.com/library/content/documentation/Darwin/Conceptual/KEXTConcept/Articles/command_line_tools.html
